...
Invoke-webRequest -Uri https://github.com/deterministicj/AntiSyphonTraining-VM-Fix-Menu/blob/main/scripts/DisableUpdates.ps1?raw=true -OutFile C:\DisableUpdates.ps1
